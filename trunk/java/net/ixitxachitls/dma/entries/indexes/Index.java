...
//   }
  ...
  public enum Path
  {
    ...
    MONSTER_SIZES, MONSTER_TYPES, MONSTER_SUBTYPES, MONSTER_HDS,
    MONSTER_DICES, MOVEMENT_MODES, MANEUVERABILITIES, NATURAL_ARMORS,
    BASE_ATTACKS, STRENGTHS, DEXTERITIES, CONSTITUTIONS, INTELLIGENCES,
    WISDOMS, CHARISMAS, SPACES, CLIMATES, TERRAINS, CRS, TREASURES, ALIGNMENTS,
    LEVEL_ADJUSTMENTS, LANGUAGES,
    EFFECT_TYPES, AFFECTS;
    // CHECKSTYLE:ON
