...
public class NewMoney extends NewValue.Addable<MoneyProto>
{
  public static class MoneyParser extends Parser<NewMoney>
  {
    ...
    @Override
    public Optional<NewMoney> doParse(String inValue)
    {
      int platinum = 0;
      int gold = 0;
      int silver = 0;
  ...
  public static Parser<NewMoney> PARSER = new MoneyParser();
