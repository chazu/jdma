...
@Immutable
public class Enumeration extends BaseCommand
{
  //--------------------------------------------------------- constructor(s)
  ...
  /**
   * The constructor for the enumeration command.
   *
   * @param       inText the text to set enumeration
   *
   */
  public Enumeration(@Nonnull Object ... inText)
  {
    this();
  ...
  public static class Test extends net.ixitxachitls.util.test.TestCase
  {
    ...
    {
      Command command = new Enumeration("e1", "e2", "e3", "e4");
      assertEquals("setup", "\\enumeration{e1}{e2}{e3}{e4}",
                   command.toString());
    }
