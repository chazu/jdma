...
public class Files extends BaseCommand
{
   ...
   *
   */
  public Files(@Nonnull Object inText)
  {
    this();
  ...
  /**
    ...
    *
    */
  public Files(@Nonnull Object inText, @Nonnull Object inName)
  {
    this(inText);
  ...
  public static class Test extends net.ixitxachitls.util.test.TestCase
  {
    ...
    {
      Command command = new Files("text");
      assertEquals("setup", "\\files{text}", command.toString());

      command = new Files("text", "name");
      assertEquals("setup", "\\files[name]{text}", command.toString());
    }
