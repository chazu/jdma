...
/**
 * This is a verbatimding action, allow to replace all white spaces with a given
 * character.
 *
 * @file          Verbatim.java
 *
...
@Immutable
public class Verbatim extends Action
{
  //--------------------------------------------------------- constructor(s)
                      ...
                      @Nullable List<? extends Object> inArguments)
  {
    ...
    inDocument.add(inArguments.get(0));
  }
  ...
  public static class Test extends net.ixitxachitls.util.test.TestCase
  {
    ...
    public void all()
    {
      Action action = new Verbatim();

      Document doc = new Document();

      action.execute(doc, null,
                     com.google.common.collect.ImmutableList.of("text"));
      assertEquals("empty", "text", doc.toString());
    }
