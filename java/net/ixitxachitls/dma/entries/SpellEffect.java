...
public enum SpellEffect implements EnumSelection.Named,
  EnumSelection.Proto<BaseSpellProto.Effect.Type>
{
  /** Unknown. */
  ...
  public static final NewValue.Parser<SpellEffect> PARSER =
    new NewValue.Parser<SpellEffect>(1)
    {
      @Override
