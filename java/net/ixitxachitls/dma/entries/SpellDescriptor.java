...
public enum SpellDescriptor
  implements EnumSelection.Named, EnumSelection.Proto<BaseSpellProto.Descriptor>
{
  /** Unknown. */
  ...
  public static final NewValue.Parser<SpellDescriptor> PARSER =
    new NewValue.Parser<SpellDescriptor>(1)
    {
      @Override
